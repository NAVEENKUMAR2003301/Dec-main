...
# ── Storage path ──────────────────────────────────────────────────────────────
# On Render free tier, /tmp persists for the lifetime of the process.
# If you add a Render Disk, set DATA_DIR to its mount path via env var.
